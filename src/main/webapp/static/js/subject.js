...
function show_subjects(persons, enterprises) {
	...
	if (persons != null && enterprises != null) {
		...
		for (var i=0; i<enterprises.length; i++) {
			tableContent += "<tr bgcolor='#ffffff'><td style='padding:2px;'>&nbsp;<b><font color='#0000ff'>" + enterprises[i].name + "</td><td style='padding:2px;'>&nbsp;Enterprise</td><td style='padding:2px;'>&nbsp;<b><font color='#0000ff'><a href='subjectSearch?subject=" + enterprises[i].enterprise + "&document=" + document.getElementById("documentId").innerHTML + "&type=" + 2 + "'><input type='button' value='Loo seos'></a></td></tr>";
		}
